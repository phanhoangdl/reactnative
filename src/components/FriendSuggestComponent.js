            ...
            <Grid>
                ...
                <Row size={8}>
                    ...
                    <FlatList 
                        ...
                        renderItem = {({item}) => {
                            return (
                                <View style={{ flexDirection: 'row', alignItems: 'center', marginLeft:10, marginTop: 10, paddingTop:5, paddingBottom:5, borderWidth:1, borderStyle: 'solid', borderColor:'rgba(128,128,128,0.1)' }}>
                                    <View style={{ flex: 1 }}>
                                        <AvatarComponent img={item.url} />
                                    </View>
                                    <View style={{ flex: 3, justifyContent: 'flex-start' }}>
